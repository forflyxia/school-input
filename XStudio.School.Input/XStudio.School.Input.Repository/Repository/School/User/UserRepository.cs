...
namespace XStudio.School.Input.Repository.School.User
{
    ...
    public partial class UserRepository
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static UserPO GetItem(int id) 
        {
        ...
        /// <returns></returns>
        public static List<UserPO> GetItems(List<int> ids)
        {
            using (var context = new SchoolContext())
            {
                return context.Users.Where(p => ids.Contains(p.Id)).ToList();
            }
        }
        ...
        /// <returns></returns>
        public static bool Save(UserPO item) 
        {
			using (var context = new SchoolContext())
            {
                if (item.Id == 0)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<UserPO> GetItemsByPaging(DataTablesPaging paging, out int total)
        {
            ...
            using (var context = new SchoolContext())
            {
                var items = context.Users.Filter(filterParameters);
                total = items.Count();
        ...
        /// </summary>
        /// <returns></returns>
        public static List<UserPO> GetAll()
        {
			using (var context = new SchoolContext())
            {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool Delete(UserPO item)
        {
            using (var context = new SchoolContext())
            {
