/************************************************************************************************************************************************
 * FileName:       ProductPriceRepository.cs
 * Author:         hbxia
...
namespace XStudio.School.Input.Repository.School.Product
{
    ...
    /// 
    /// </summary>
    public partial class ProductPriceRepository
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public static ProductPricePO GetItem(int id) 
        {
        ...
        /// <returns></returns>
        public static List<ProductPricePO> GetItems(List<int> ids)
        {
            using (var context = new SchoolContext())
            {
                return context.ProductPrices.Where(p => ids.Contains(p.Id)).ToList();
            }
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static ProductPricePO GetDataForSave(int id)
        {
			ProductPricePO item;
            if (id == 0)
            {
                item = new ProductPricePO()
                {
    				ProductId = 0,
    				Unitprice = 0,
    				Status = 0,
        ...
        /// <returns></returns>
        public static bool Save(ProductPricePO item) 
        {
			using (var context = new SchoolContext())
            {
                if (item.Id == 0)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ProductPricePO> GetItemsByPaging(DataTablesPaging paging, out int total)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ProductPricePO> GetAll()
        {
			using (var context = new SchoolContext())
            {
        ...
        {
            var item = new ProductPricePO {Id = id};
            return Delete(item);
        }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool Delete(ProductPricePO item)
        {
            using (var context = new SchoolContext())
            {
                context.ProductPrices.Attach(item);
