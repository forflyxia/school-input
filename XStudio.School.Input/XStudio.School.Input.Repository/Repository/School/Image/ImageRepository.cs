...
namespace XStudio.School.Input.Repository.School.Image
{
    /// <summary>
    /// 图片信息
    /// </summary>
    public partial class ImageRepository
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static ImagePO GetItem(int id) 
        {
        ...
        /// <returns></returns>
        public static List<ImagePO> GetItems(List<int> ids)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static ImagePO GetDataForSave(int id)
        {
			ImagePO item;
            if (id == 0)
            {
        ...
        /// <returns></returns>
        public static bool Save(ImagePO item) 
        {
			using (var context = new SchoolContext())
            {
                if (item.Id == 0)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ImagePO> GetItemsByPaging(DataTablesPaging paging, out int total)
        {
            ...
            using (var context = new SchoolContext())
            {
                var items = context.Images.Filter(filterParameters);
                total = items.Count();
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ImagePO> GetAll()
        {
			using (var context = new SchoolContext())
            {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public static bool Delete(ImagePO item)
        {
            using (var context = new SchoolContext())
            {
                context.Images.Attach(item);
